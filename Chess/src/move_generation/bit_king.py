...
"""
try:
    from Chess.src.bitboard_implementation.bit_move import BitMove
    from src.constants import (
        WHITE_LONG_EMPTY_CASTLE_POS, WHITE_SHORT_EMPTY_CASTLE_POS, WHITE_MOVETO_SHORT_CASTLE_POS, WHITE_MOVETO_LONG_CASTLE_POS, WHITE_LONG_ROOK_POS, WHITE_SHORT_ROOK_POS,
        BLACK_LONG_EMPTY_CASTLE_POS, BLACK_SHORT_EMPTY_CASTLE_POS, BLACK_MOVETO_SHORT_CASTLE_POS, BLACK_MOVETO_LONG_CASTLE_POS, BLACK_LONG_ROOK_POS, BLACK_SHORT_ROOK_POS,
